...
const SERVICES = [
  ...
  { t: "Beneficiaries & Estates", c: C.purple, tc: C.purple,
    d: "Name who receives your TFSA, RRSP or RRIF, and, when a member has died, help for the family and executor settling their accounts. For a will or a trust, see a lawyer or notary.",
    b: ["Beneficiary designations on registered plans", "Help for executors and families", "Wills and trusts: a lawyer or notary"],
    go: ["estate", "When a member has died"] },
