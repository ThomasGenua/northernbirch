    ...
    <section className="sec" style={{background:C.cream,}}>
      <div style={{maxWidth:800,margin:"0 auto"}}>
        ...
        {[
          ...
          {t:"Insurance",p:"Northern Birch Credit Union does not sell, quote or underwrite insurance through this website. Where insurance is mentioned, Northern Birch refers members to insurers, who set eligibility, coverage and price under their own terms. Insurance products are not deposits, are not insured by the Financial Services Regulatory Authority of Ontario (FSRA), and are not guaranteed by Northern Birch Credit Union. This site is an illustrative demonstration prepared by Oodler Inc.; any insurer named on it as proposed has no arrangement with Northern Birch."},
          ...
          {t:"Limitation of Liability",p:"Northern Birch Credit Union provides this website and its tools (including the Coverage Explorer, financial calculators, and other illustrative tools) on an 'as is' basis. We do not warrant the accuracy, completeness, or reliability of any information or calculations. Northern Birch shall not be liable for any direct, indirect, incidental, or consequential damages arising from the use of this website."},
