    ...
    <section className="sec" style={{background:C.cream,}}>
      <div style={{maxWidth:800,margin:"0 auto"}}>
        ...
        {[
          ...
          {t:"Website Accessibility",p:"We strive to make our website accessible to WCAG 2.1 Level AA standards. Features include: keyboard navigation support, screen reader compatibility, sufficient colour contrast, resizable text, descriptive alt text for images, and clear navigation structure. If you encounter any accessibility barriers on our website, please contact us."},
          ...
          {t:"Branch Accessibility",p:"If you need an accessible entrance, parking, a support person or assistive listening at a branch, tell us before you visit and the branch will confirm what it can arrange. The accessibility of each branch has not been confirmed for this demonstration."},
