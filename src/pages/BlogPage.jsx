...
export default function BlogPage({setPage}){
  const posts=[
    ...
    {title:"Travelling to Estonia or Latvia This Summer?",go:["travel","Travel & FX services"],date:"March 2026",cat:"Travel",excerpt:"Travel travel insurance now available for Northern Birch members. Emergency medical Allianz-underwritten, eligibility set by Allianz coverage for seniors, and 24/7 assistance in Estonian and Latvian.",color:C.amberText},
    {title:"Co-op & Co-ownership Mortgages: What You Need to Know",go:["insurance","See insurance products"],date:"March 2026",cat:"Insurance Education",excerpt:"Living in a co-op? Standard condo insurance won't adequately cover you. Northern Birch is one of the few institutions offering specialized co-op mortgage lending in Ontario. Here's why it matters.",color:C.purple},
