  ...
  return(
    <section className="sec" style={{background:C.cream,}}>
      <div style={{maxWidth:700,margin:"0 auto"}}>
        <SH tag="Book an Appointment" tagColor={C.greenText} title="Meet with an advisor" desc="Ask for a meeting at any branch about banking, a mortgage, investments, financial planning or an insurance referral."/>
        ...
        <div style={{background:"#fff",borderRadius:24,padding:40,border:"1px solid #eee"}}>
          ...
          <div style={{marginBottom:20}}><label htmlFor="sel-2" style={{fontFamily:fs,fontSize:12,color:"#6B6B6B",display:"block",marginBottom:6}}>Service Needed</label><select id="sel-2" value={service} onChange={e=>setService(e.target.value)} style={{width:"100%",border:"1px solid #ddd",borderRadius:10,padding:"12px 16px",fontFamily:fs,fontSize:14,outline:"none",boxSizing:"border-box",background:"#fff"}}><option value="">What do you need help with?</option><option>Insurance referral</option><option>Mortgage Consultation</option><option>Investment & Wealth Review</option><option>Estates (a member has died)</option><option>Business banking</option><option>International Transfers Setup</option><option>Financial Check-Up (General)</option><option>New Member Onboarding</option></select></div>
          ...
          <ConsentNotice id="booking-consent" checked={consent} onChange={setConsent} purpose="so a branch could contact you about this appointment"/>
