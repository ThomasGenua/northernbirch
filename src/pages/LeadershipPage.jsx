        ...
        {tab==="overview"&&<div>
          ...
          <div style={{background:`${C.navy}06`,borderRadius:20,padding:isMob?24:32,border:`1px solid ${C.navy}12`}}>
            ...
            <div className="grid-2-1" style={{gap:10}}>
              {["7 AI features powered by Claude Opus 4.6 (real API calls, real conversations)","Real-time insurance Coverage Explorer with actuarial math","Trilingual experience (English, Estonian, Latvian) -- 80+ translated strings","Credit score monitoring, budgeting, and spending categorization","International transfer widget with live EUR exchange rates","Digital document signing and identity verification","Claims filing wizard, appointment booking, coverage comparison","Canadian regulatory compliance (PIPEDA, AODA, FSRA, FINTRAC)","Estonian/Latvian cultural branding (birch trees, cornflowers, daisies, folk patterns)","Tax & savings optimizer with RRSP/TFSA calculators"].map((f,i)=>
        ...
        {tab==="implementation"&&<div>
          <div style={{background:"#fff",borderRadius:24,padding:isMob?24:40,border:"1px solid #eee",marginBottom:24}}>
            ...
            {[
              ...
              {phase:"Month 14-18",title:"Optimization & Expansion",color:C.redText,items:["RIBO subsidiary transition (if volume justifies)","Estates administration content","Payroll partnerships active","Cross-sell analytics and optimization","Board performance reporting"]},
            ].map((phase,i)=>(
