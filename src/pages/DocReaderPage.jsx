  ...
  return(
    <section className="sec" style={{background:C.cream,}}>
      <div style={{maxWidth:900,margin:"0 auto"}}>
        <SH tag="AI Document Reader" tagColor={C.accentText} title="Understand your existing coverage" desc="Paste text from any insurance policy, renewal notice, or coverage summary. Our AI will pull out the key details in plain language and flag questions worth asking your insurer."/>
