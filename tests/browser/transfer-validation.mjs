...
const send=()=>p.locator('main button',{hasText:/Request a C\$|Enter an amount to request/}).first();
const state=async()=>{
...
check(/Request a C\$3,000\.00/.test(t),'request button formats the amount');
