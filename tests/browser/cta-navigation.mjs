...
const CASES=[
  ...
  ['/community','About the KESKUS branch','/keskus'],
  ['/keskus','Branches and hours','/contact'],
  ['/borrowing','Co-op and co-ownership lending','/mortgages'],
  ['/borrowing','See cards and their benefits','/cards'],
  ['/phased-ask','Underwriter matrix','/underwriters'],
